...
class Hero extends Player{
  constructor(name, type, attackLevel, healthLevel, superPowers = []){
  ...
  useSuperPower(index) {return `${this.name} used ${this.superPowers[index]}!`}
}
/*
...
fireSpitter.addSuperPower('eating fire');
